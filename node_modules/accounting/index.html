...
<body>
    <section>
        <h1>accounting.js</h1>
        <p><strong>accounting.js</strong> is a tiny JavaScript library by <a href="https://openexchangerates.org" title="Open Exchange Rates free currency data API" target="_blank">Open Exchange Rates</a>, providing simple and advanced number, money and
        ...
        <p><a href="http://twitter.com/share" class="twitter-share-button" data-count="horizontal" data-via="josscrowcroft" data-url="http://openexchangerates.github.io/accounting.js" data-text="accounting.js - JavaScript library for money/currency formatting">Tweet</a>            &nbsp;
...
accounting.unformat("&euro; 1.000.000,00", ","); // 1000000</pre>
    ...
    <section id="support">
        ...
        <p>Please create issues on the <a href="https://github.com/openexchangerates/accounting.js" title="accounting.js Github repository">accounting.js Github repository</a> if you have feedback or need support, or <a href="mailto:info@openexchangerates.org"
                title="Contact Open Exchange Rates">contact Open Exchange Rates here</a>.</p>
    </section>
    ...
    <section id="links">
        ...
        <h2>Links</h2>
        <p>accounting.js is maintained by <strong><a href="https://openexchangerates.org" title="Open Exchange Rates free currency data API" target="_blank">Open Exchange Rates</a></strong> - the lightweight currency data API for startups, SMEs and Fortune
            500s.</p>
        ...
        <p>accounting.js works great with <strong><a href="http://openexchangerates.github.com/money.js" title="money.js - JavaScript currency conversion library">money.js</a></strong> - the tiny (1kb) standalone JavaScript currency conversion library, for
            web & nodeJS</p>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function($) {
            ...
            $columnValues.bind('keydown keyup keypress focus blur paste', function() {
                var list = $.map($columnValues, function(each) {
                        return $(each).val();
                    }),
